...
jQuery(function () {
    var viewModel = new Scrum.PlanSprintViewModel();
...
(function (Scrum) {
    var PlanSprintViewModel = (function (_super) {
        ...
        PlanSprintViewModel.prototype.AddResource = function () {
            this.resources.push(new Scrum.Resource('', 0, 0, 0));
        };
        ...
        PlanSprintViewModel.prototype.AddStory = function () {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    _this.stories.push(new Scrum.Story(data.StoryId, '', 0, data.Ordinal, data.IsReachGoal, _this.tags));
                    ...
                    // see http://nrcwiki.nationalresearch.com/mediawiki/index.php/SoftwareEngineering/ScrumBoard
    ...
    Scrum.PlanSprintViewModel = PlanSprintViewModel;
})(Scrum || (Scrum = {}));
