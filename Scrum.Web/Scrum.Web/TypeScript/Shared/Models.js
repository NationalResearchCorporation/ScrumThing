...
(function (Scrum) {
    ...
    var Story = (function () {
        function Story(storyId, storyText, storyPoints, ordinal, isReachGoal, tags) {
            ...
            this.StoryPoints = Scrum.observableNumber();
            ...
            this.TotalDevHours = ko.computed(function () {
                return Scrum.sum(_.map(_this.Tasks(), function (task) {
    ...
    var Task = (function () {
        function Task(raw) {
            ...
            this.EstimatedDevHours = Scrum.observableNumber();
            this.EstimatedQsHours = Scrum.observableNumber();
            this.DevHoursBurned = Scrum.observableNumber();
            this.QsHoursBurned = Scrum.observableNumber();
            this.RemainingDevHours = Scrum.observableNumber();
            this.RemainingQsHours = Scrum.observableNumber();
    ...
    Scrum.RawAssignment = RawAssignment;
