...
BEGIN
    ...
    DECLARE @UserName VARCHAR(40) = 'TestUser';
    DECLARE @TaskId INT,
    ...
    EXEC UpdateTask @UserName, @TaskId, @TaskText, @NewState, @EstimatedDevHours, @EstimatedQsHours, @DevHoursBurned, @QsHoursBurned, @RemainingDevHours, @RemainingQsHours, @TaskTags
