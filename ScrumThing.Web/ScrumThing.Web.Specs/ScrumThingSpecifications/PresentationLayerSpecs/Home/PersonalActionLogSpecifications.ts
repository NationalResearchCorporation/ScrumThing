describe("The Personal Action Log", () => {
    ...
    describe("general error checking", () => {
    ...
    describe("timeperiods list", () => {
        ...
        describe("each timeperiod", () => {
            ...
            describe("each task", () => {
                ...
                describe("general task information", () => {
                ...
                describe("burned hour information", () => {
                ...
                describe("remaining hour information", () => {
